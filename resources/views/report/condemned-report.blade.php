...
@section('title', 'Condemned Report')
      ...
      <div class="col-lg-12">
          <div class="panel panel-primary">
              <div class="panel-heading">
                  <h3 class="panel-title">
                      <i class="livicon" data-name="doc-portrait" data-c="#fff" data-hc="#fff" data-size="18" data-loop="true"></i> Condemned
                  </h3>
          ...
          <div class="panel-body table-responsive">
                  ...
                  <div class="btn-group" style="margin-left: 655px">
                      <a href="{{ route('report.condemnedpdf')  }}" class="btn btn-info">Print <span class="glyphicon glyphicon-print"></span></a>
                  </div>
