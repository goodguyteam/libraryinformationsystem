    ...
    <div class="row">
        <div class="col-md-12">
            <div class="panel panel-primary">
                <div class="panel-heading">Genre List</div>
                <div class="panel-body table-responsive">
                    Toggle Column:
                    <div class="btn-group" style="margin:10px 0;">
                        <button type="button" class="toggle-vis btn btn-default" data-column="0">Genre</button>
                    ...
                    <button class="pull-right btn btn-primary" data-toggle="modal" data-target="#addNewGenre">Add New Genre</button>
                    <table class="table table-striped table-bordered" id="table3">
                        ...
                        @foreach($genres as $genre)
                            <tr>
                                ...
                                <td><button class="btn btn-success" data-toggle="modal" data-target="#editGenre{{ $genre->id }}"><i class="livicon" data-name="edit" data-size="20" data-color="#fff" data-hc="#ccc" data-loop="true"></i></button></td>
                            </tr>
                        @endforeach
                        </tbody>
                    </table>
        ...
        @section('modals')
            <div class="modal fade modal-fade-in-scale-up" tabindex="-1" id="addNewGenre" role="dialog" aria-labelledby="modalLabelfade" aria-hidden="true">
            ...
            @foreach($genres as $genre)
                <div class="modal fade modal-fade-in-scale-up" tabindex="-1" id="editGenre{{ $genre->id }}" role="dialog" aria-labelledby="modalLabelfade" aria-hidden="true">
                    <div class="modal-dialog" role="document">
                        <div class="modal-content">
                            <div class="modal-header bg-primary">
                                <h4 class="modal-title" id="modalLabelfade">Edit Genre</h4>
                            </div>
                                ...
                                <div class="modal-body">
                                    <div class="row">
                                        <div class="col-md-12">
                                            <h4>Genre</h4>
                                            <p>
                                                <input id="name" name="name" type="text" placeholder="Genre" class="form-control" value="{{ $genre->name }}">
                                            </p>
                                        </div>
                                        <div class="col-md-12">
                                            <h4>Description</h4>
                                            <p>
                                                <input id="name" name="description" type="text" placeholder="Description" class="form-control" value="{{ $genre->description }}">
                                            </p>
                                        </div>
                                    </div>
                                </div>
